    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
            <div class="modal-header justify-content-center border-bottom-0">
                {{-- <img src="{{ asset('template/img/dpa-header.png') }}" alt="CPSU Header" class="img-fluid" style="max-height: 100px;"> --}}
                {{--  <button type="button" class="close position-absolute" style="top: 15px; right: 20px;" data-dismiss="modal" aria-label="Close">
            ...
            <div class="text-center pb-3">
                {{-- <img src="{{ asset('template/img/dpa-footer.png') }}" alt="CPSU Footer" class="img-fluid" style="max-height: 100px;"> --}}
            </div>

            <div class="modal-footer flex-column align-items-start px-4 px-md-5 px-lg-5">
                <!-- Checkbox with label -->
                ...
                <div class="d-flex">
                    <a href="{{ route('logout') }}" id="declineBtn" class="text-danger font-weight-bold mr-3">DECLINE & SIGN OUT</a>
                    <button type="button" class="btn btn-success" id="acceptBtn" disabled>Accept</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    document.getElementById('acceptBtn').addEventListener('click', function () {
        updateDpaStatus(1); // Accepted
    });

    document.getElementById('declineBtn').addEventListener('click', function () {
    updateDpaStatus(null); // Declined → set to NULL
});
