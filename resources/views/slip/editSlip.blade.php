                ...
                <div class="card shadow-sm">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <h4 class="text-bold mb-11">
                            Attachment:
                            <a href="{{ route('viewPdfslip', $routingSlips->id) }}" target="_blank" class="badge badge-primary text-white">
                    ...
                    <div class="card-body">
                        <form action="{{ route('updateSlip', $routingSlips->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="file_stamp" name="file_stamp" accept=".jpg,.jpeg,.png">
