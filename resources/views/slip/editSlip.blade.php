                    ...
                    <div class="card-body">
                        <form action="{{ route('updateSlip', $routingSlips->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" class="form-control float-right" id="op_ctrl" name="op_ctrl" placeholder="Control number" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <input type="hidden" class="form-control" name="pres_dept" value="{{ $userDepartment }}" readonly>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <textarea class="form-control" id="r_destination" name="r_destination" rows="2" placeholder="This Document is For/To..." required></textarea>
                                </div>
                            </div>
                            {{-- <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="route_status" value="2" readonly hidden>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-3"></div>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" id="user_id" name="user_id" value="{{ $routingSlips->user_id }}" readonly hidden>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-3"></div>
