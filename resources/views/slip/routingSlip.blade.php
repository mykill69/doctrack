                            ...
                            <div class="card card-success card-outline">
                                <div class="card-header p-2">
                                    <ul class="nav nav-tabs" id="routingTabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="#routed2" data-toggle="tab">
                                                Routed back to Records
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="#routed1" data-toggle="tab">
                                                Routed to President
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        ...
                                        @foreach (['routed2' => 'Routed back to Records', 'routed1' => 'Routed to President', 'served' => 'Served', 'enroute' => 'En Route'] as $tabId => $label)
                                                                            ...
                                                                            @switch($slip->route_status)
                                                                                @case(1)
                                                                                    <p class="badge badge-warning"
                                                                                        style="font-size:9px;">Routed
                                                                                        to<br>President</p>
                                                                                @break

                                                                                @case(2)
                                                                                    <p class="badge badge-info"
                                                                                        style="font-size:9px;">Routed back
                                                                                        to<br>Records Office</p>
                                                                                @break
